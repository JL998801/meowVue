            ...
            <div class="carousel-wrapper">
                ...
                <div class="carousel">
                    <template v-if="displayedCases[category.type] && displayedCases[category.type].length > 0">
                        <div v-for="caseItem in displayedCases[category.type]" :key="caseItem.bannerId"
                            class="carousel-item" @click="goToCaseDetail(caseItem)" style="cursor: pointer;">
                            <img :src="caseItem.imageUrl ? caseItem.imageUrl : '/images/default.png'" alt="案件圖片"
                                class="case-image" />
